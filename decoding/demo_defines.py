...
BUSINESS_DEMOS = {
    "Industrial": [
        ...
        DEMO_GESTURE, DEMO_SURFACE, DEMO_LEVEL_SENSING, DEMO_GROUND_SPEED, DEMO_CALIBRATION, DEMO_EBIKES, DEMO_REPLAY, DEMO_VIDEO_DOORBELL
    ],
    "BAC": [
        DEMO_OOB_x843, DEMO_OOB_x432, DEMO_OOB_x844, DEMO_3D_PEOPLE_TRACKING, DEMO_GESTURE, DEMO_KTO, DEMO_CALIBRATION, DEMO_DASHCAM, DEMO_REPLAY, DEMO_INTRUDER
    ]
}
...
DEVICE_DEMO_DICT = {
    ...
    "xWRL6432": {
        ...
        "isxWRLx844" : False,
        "singleCOM": True,
        "demos": [DEMO_OOB_x432, DEMO_LEVEL_SENSING, DEMO_GESTURE, DEMO_SURFACE, DEMO_GROUND_SPEED, DEMO_SMALL_OBSTACLE, DEMO_KTO, DEMO_VITALS, DEMO_DASHCAM, DEMO_REPLAY, DEMO_EBIKES, DEMO_VIDEO_DOORBELL, DEMO_CALIBRATION]
    },
    "xWRL1432": {
        "isxWRx843": False,
        "isxWRLx432": True,
    ...
    "xWRL6844": {
        ...
        "isxWRLx844" : True,
        "singleCOM" : False,
        "demos" : [DEMO_OOB_x844, DEMO_INTRUDER]
